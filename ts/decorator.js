...
function LogClass(target, context) {
    console.log("Class was defined!", { target: target, context: context });
}
function LogMethod(target, context) {
    console.log("Method \"".concat(context.name.toString(), "\" was called."), { target: target, context: context });
}
var MyClass = function () {
    ...
    var MyClass = _classThis = /** @class */ (function () {
        ...
        MyClass_1.prototype.myMethod = function () {
